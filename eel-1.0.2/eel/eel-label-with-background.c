...
/* eel-label-with-background.c - A EelLabel that uses EelBackground.
...
#include "eel-label-with-background.h"
...
GtkWidget *
eel_label_new_with_background (const char *text)
{
	GtkWidget *label;
	
	label = eel_label_new (text);

	eel_label_set_background_mode (EEL_LABEL (label),
