...
static gchar *PropertyBoxNotebook = "GnomePropertyBox:notebook";

static gchar *Title = "GnomePropertyBox|GtkWindow::title";
static gchar *Position = "GnomePropertyBox|GtkWindow::position";
...
static gchar *WMName = "GnomePropertyBox|GtkWindow::wmclass_name";
static gchar *WMClass = "GnomePropertyBox|GtkWindow::wmclass_class";
...
show_gnome_property_box_dialog (GbWidgetNewData * data)
{
  ...
  dialog = glade_util_create_dialog (_("New GnomePropertyBox"), data->parent,
				     on_gnome_property_box_dialog_ok, data,
				     &vbox);
...
gnome_property_box_new_tab_label ()
{
  ...
  gb_widget_set_child_name (label, "Notebook:tab");
  return label;
}
...
gb_gnome_property_box_write_source (GtkWidget * widget, GbWidgetWriteSourceData * data)
{
  ...
  source_add (data, "\n");
  child_name = gtk_widget_get_name (GNOME_PROPERTY_BOX (widget)->notebook);
...
{
  if (!strcmp (child_name, PropertyBoxNotebook))
