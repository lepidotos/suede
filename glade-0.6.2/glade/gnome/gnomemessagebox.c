...
static gchar *Position = "GnomeMessageBox|GtkWindow::position";
...
static gchar *WMName = "GnomeMessageBox|GtkWindow::wmclass_name";
static gchar *WMClass = "GnomeMessageBox|GtkWindow::wmclass_class";
...
static const gchar* GbMessageBoxTypePixmapFilenames[] =
{
  "gnome-info.png",
  "gnome-warning.png",
  "gnome-error.png",
