...
static const gchar *Rows = "GtkTable::rows";
static const gchar *Columns = "GtkTable::columns";
...
static const gchar *GbXPad = "GtkTableChild::xpad";
static const gchar *GbYPad = "GtkTableChild::ypad";
