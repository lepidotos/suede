...
/* This outputs code to create a GtkPixmap widget with the given identifier,
   and using the given filename. It will try to look in the installed directory
   and in the source directory to find the pixmap. */
