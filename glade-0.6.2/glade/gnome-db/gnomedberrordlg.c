...
static gchar *Position = "GnomeDbErrorDlg|GtkWindow::position";
...
static gchar *WMName = "GnomeDbErrorDlg|GtkWindow::wmclass_name";
static gchar *WMClass = "GnomeDbErrorDlg|GtkWindow::wmclass_class";
